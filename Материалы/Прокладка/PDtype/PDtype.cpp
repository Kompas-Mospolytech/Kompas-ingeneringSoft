...
// PDtype.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPDtypeApp, CWinApp)
...
// Единственный объект CPDtypeApp

CPDtypeApp theApp;


// Инициализация CPDtypeApp

BOOL CPDtypeApp::InitInstance()
{
